...
If OpenWindow(0, 100, 200, 500, 300, "MDWin", #PB_Window_MinimizeGadget | #PB_Window_MaximizeGadget | #PB_Window_SizeGadget)

  CreateStatusBar(0, WindowID(0))
    AddStatusBarField(#PB_Ignore)
    StatusBarText(0, 0, "MDWin Cursor Downloading Software!", 0)

  If WebGadget(10, 0, 31, 0, 0, "file:///C:/MDWin/MDWin.html") = 0
...
; EnableXP
; DPIAware
; UseIcon = C:\MDWin\Icon.ico
; Executable = MDWin.exe
; IncludeVersionInfo
; VersionField0 = 1.0
; VersionField1 = 1.0
